...
public class Juego extends JFrame {
	...
	private Jugador gamer; // Variable que recoge los datos del jugador indicados en la ventana Registro
	...
	public Juego() {
		...
		contentPane.add(cajaOperaciones);
		...
		contentPane.add(btnCompruebaResultado);
	  ...
	  //Identificamos el dado que hemos seleccionado
		...
		int numeroDado=Integer.valueOf(dado.getName());
		 ...
		 if(tocaNumero){
			 ...
			 //”Apagemos el listener” para el dado escogido dado
