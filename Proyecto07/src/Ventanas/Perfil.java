...
public class Perfil extends JPanel {
	...
	public Perfil() {
		...
		lblPuntuacin.setForeground(Color.BLUE);
		lblPuntuacin.setFont(new Font("Arial Narrow", Font.PLAIN, 20));
		add(lblPuntuacin);
		...
		public void setJugador (Jugador gamer){
			...
			textFieldEdad.setText(Integer.toString(gamer.getEdad()));
			textFieldPuntuacion.setText(Integer.toString(gamer.getPuntuacion()));;
